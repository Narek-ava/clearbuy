<x-custom-layout>
    ...
    <x-slot name="top">
        <div class="flex items-center">
            <x-common.button.group>
                <x-common.button.a href="/admin/badge?backUrl={{ urlencode($backUrl) }}">New badge
                </x-common.button.a>
    ...
    <x-list>
            ...
            <form class="deleteItemsForm" action="delete_badges" method="post">
                @csrf
                ...
                <x-common.table.table x-data="tableComponent('{{$sort}}', '{{$order}}')">
                    <x-slot name="thead">
                        ...
                        <x-common.table.th>
                            <x-common.sortable sort="{{ $sort }}" order="{{ $order }}" name="year" />
                        </x-common.table.th>
                    ...
                    @foreach ($items as $item)
                        <x-common.table.tr>
                            ...
                            <x-common.table.td>{{ $item->year }}</x-common.table.td>
                            <x-common.table.td>
                                <x-common.button.group  class="justify-end">
                                    <x-common.button.a href="/admin/badge?id={{ $item->id }}&backUrl={{ urlencode($backUrl) }}">
                                        Edit
                                    </x-common.button.a>
                                </x-common.button.group>
                            </x-common.table.td>
