<x-custom-layout>
    ...
    <x-slot name="top">
        <div class="flex items-center">
            <x-common.button.group>
                <x-common.button.a href="/admin/auth_domain?backUrl={{ urlencode($backUrl) }}">New Domain
                </x-common.button.a>
            </x-common.button.group>
    ...
    <x-list>
        ...
        <form class="deleteItemsForm" action="delete_auth_domains" method="post">
            @csrf
                    ...
                    <x-common.table.tr>
                        ...
                        <x-common.table.td>
                            <x-common.button.group  class="justify-end">
                                <x-common.button.a href="/admin/auth_domain?id={{ $item->id }}&backUrl={{ urlencode($backUrl) }}">
                                    Edit
                                </x-common.button.a>
                            </x-common.button.group>
                        </x-common.table.td>
