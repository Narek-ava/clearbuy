<x-custom-layout>
    ...
    <x-slot name="top">
        <div class="flex items-center">
            <x-common.button.group>
                <x-common.button.a href="/admin/website?backUrl={{ urlencode($backUrl) }}">New Website
                </x-common.button.a>
    ...
    <x-list>
        <x-slot name="search">
            ...
            <div class="space-x-2">
                <label>URL</label>
                <input type="text" name="url" value="{{ Request()->url }}" class="border px-2 py-0.5">
            </div>
            <div class="space-x-2">
                <label>Description</label>
                <input type="text" name="description" value="{{ Request()->description }}" class="border px-2 py-0.5">
            </div>
        </x-slot>
        ...
        <form class="deleteItemsForm" action="delete_websites" method="post">
            @csrf
                    ...
                    <x-common.table.tr>
                        ...
                        <x-common.table.td>
                            <x-common.button.group  class="justify-end">
                                <x-common.button.a href="/admin/website?id={{ $item->id }}&backUrl={{ urlencode($backUrl) }}">
                                    Edit
                                </x-common.button.a>
                            </x-common.button.group>
                        </x-common.table.td>
