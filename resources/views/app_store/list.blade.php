<x-custom-layout>
    ...
    <x-slot name="top">
        <div class="flex items-center">
            <x-common.button.group>
                <x-common.button.a href="/admin/app_store?backUrl={{ urlencode($backUrl) }}">New Store
                </x-common.button.a>
    ...
    <x-list>
        ...
        <form class="deleteItemsForm" action="delete_app_stores" method="post">
            @csrf
            ...
            <x-common.table.table x-data="tableComponent('{{$sort}}', '{{$order}}')">
                <x-slot name="thead">
                    ...
                    <x-common.table.th>Icon</x-common.table.th>
                    ...
                    <x-common.table.tr>
                        ...
                        <x-common.table.td>
                            <x-common.button.group  class="justify-end">
                                <x-common.button.a href="/admin/app_store?id={{ $item->id }}&backUrl={{ urlencode($backUrl) }}">
                                    Edit
                                </x-common.button.a>
                            </x-common.button.group>
                        </x-common.table.td>
