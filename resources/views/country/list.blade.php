<x-custom-layout>
    ...
    <x-slot name="top">
        <div class="flex items-center">
            <x-common.button.group>
                <x-common.button.a href="/admin/country?backUrl={{ urlencode($backUrl) }}">New Country
                </x-common.button.a>
    ...
    <x-list>
        ...
        <form class="deleteItemsForm" action="delete_countries" method="post">
            @csrf
                    ...
                    <x-common.table.tr>
                        ...
                        <x-common.table.td>
                            <x-common.button.group  class="justify-end">
                                <x-common.button.a href="/admin/country?id={{ $item->id }}&backUrl={{ urlencode($backUrl) }}">
                                    Edit
                                </x-common.button.a>
                            </x-common.button.group>
                        </x-common.table.td>
